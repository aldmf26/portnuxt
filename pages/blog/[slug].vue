...
<template>
    ...
    <div v-else>
        <div role="status" class="float-center items-center">
            <svg aria-hidden="true" class="w-1/6 h-1/6 text-center float-center justify-center items-center text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
